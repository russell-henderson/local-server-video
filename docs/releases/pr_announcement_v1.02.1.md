...
Notes for channels: This release finalizes the v1.02 cycle with a docs-only patch. All tests passed in isolated verification; 9 missing documentation links remain under review and will be remediated in follow-up doc PRs.
